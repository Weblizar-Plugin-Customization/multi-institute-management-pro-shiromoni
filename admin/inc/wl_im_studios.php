...
<div class="container-fluid wl_im_container">
    ...
    <div class="row">
        <div class="col">
            ...
            <h2 class="text-center font-weight-normal">
                <span class="border-bottom"><i class="fa fa-users"></i> <?php esc_html_e('Studio', WL_MIM_DOMAIN); ?></span>
            </h2>
            <?php
            ...
            <div class="mt-3 alert alert-info text-center" role="alert">
                <?php esc_html_e('Here, you can either add a new room/studio or edit existing studios.', WL_MIM_DOMAIN); ?>
            </div>
            ...
            <div class="card-header bg-primary text-white">
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="h4"><?php esc_html_e('Manage Studio', WL_MIM_DOMAIN); ?></div>
                    </div>
                    <div class="col-md-6 col-xs-12">
                        <button type="button" class="btn btn-outline-light float-right add-studio ml-2" data-toggle="modal" data-target="#add-studio" data-backdrop="static" data-keyboard="false">
                            <i class="fa fa-plus"></i> <?php esc_html_e('Add New Studio', WL_MIM_DOMAIN); ?>
                        </button>
                        <!-- <button type="button" class="btn btn-outline-light float-right import-student" data-toggle="modal" data-target="#import-student" data-backdrop="static" data-keyboard="false">
                            <i class="fa fa-cloud-upload"></i> <?php esc_html_e('Bulk Import Studio', WL_MIM_DOMAIN); ?>
                        </button> -->
                    </div>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                                ...
                                <div class="col">
                                    <ul>
                                        ...
                                        if (isset($status_output)) { ?>
                                            <li class="font-weight-bold mt-1"><?php echo esc_html($status_output) . ' ' . esc_html__('Studio Id', WL_MIM_DOMAIN); ?></li>
                                        <?php
                                        }
                                        if (isset($course_output)) { ?>
                                            <li>
                                                <span class="font-weight-bold"><?php esc_html_e('Studio Name', WL_MIM_DOMAIN); ?>:&nbsp;</span>
                        ...
                        <table class="table table-hover table-striped table-bordered" id="roomList">
                            <?php
                            $entity = 'rooms';
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><?php esc_html_e('Studio Name', WL_MIM_DOMAIN); ?></th>
    ...
    <div class="modal fade" id="add-studio" tabindex="-1" role="dialog" aria-labelledby="add-studios-label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-topic-label"><?php esc_html_e('Add New Room/Studio', WL_MIM_DOMAIN); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="post" id="wim_add_room">
                    <div class="modal-body pr-4 pl-4">                        
                        <?php 
                            wp_nonce_field( 'add-room', 'add-room' );
                        ?>                        
                        <div class="wlim-add-topic-form-fields">                            
                            ...
                            <div class="row">
                                <div class="form-group wlim-selectpicker col">
                                    ...
                                    <input type="text" name="wlim-room" id="wlim-room" class="form-control" />                                    
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col">                                
                                    ...
                                    <input type="text" name="wlim-roomno" id="wlim-roomno" class="form-control" />
                                </div>
                            </div>
     ...
     <!-- update topic modal -->
     <div class="modal fade" id="update-room" tabindex="-1" role="dialog" aria-labelledby="update-room-label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="update-room-label"><?php esc_html_e( 'Update Room', WL_MIM_DOMAIN ); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="post" id="wim_update_room">             
                <?php                     
                    wp_nonce_field( 'update-room', 'update-room' );
                ?>
                <div class="modal-body pr-4 pl-4" id="fetch_room"></div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><?php esc_html_e( 'Cancel', WL_MIM_DOMAIN ); ?></button>
                    <button type="submit" class="btn btn-primary update-main-room-submit"><?php esc_html_e( 'Update Room', WL_MIM_DOMAIN ); ?></button>
                </div>
                </form>
            </div>
        </div>
