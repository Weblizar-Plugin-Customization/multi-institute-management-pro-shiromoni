...
<!-- <div class="wlsm-container d-flex mb-2">
	<div class="col-md-12 wlsm-text-center">
		<br>
		<button type="button" data-css="<?php echo esc_attr($css); ?>" class="<?php echo esc_attr($print_button_classes); ?>" id="wlsm-print-certificate-btn" data-title="<?php esc_attr_e('Print Certificate', WL_MIM_DOMAIN); ?>" data-styles='["<?php echo esc_url(WL_MIM_PLUGIN_URL . 'assets/css/bootstrap.min.css'); ?>","<?php echo esc_url(WL_MIM_PLUGIN_URL . 'assets/css/wlsm-school-header.css'); ?>","<?php echo esc_url(WL_MIM_PLUGIN_URL . 'assets/css/print/wlsm-certificate.css'); ?>"]'><?php esc_html_e('Print Certificate', WL_MIM_DOMAIN); ?></button>
	</div>
</div> -->
